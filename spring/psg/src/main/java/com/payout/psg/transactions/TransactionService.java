...
public class TransactionService {
	...
	public List<TransactionReceiveStatus> receive(List<Transaction> trxList) throws JsonProcessingException, InterruptedException{		
		...
		// Liste des threads
		List<TransactionReceiverBatchProcessorThread> threads = new ArrayList<TransactionReceiverBatchProcessorThread>();
		...
		for(List<Transaction> batch: batchs) {
			...
			TransactionReceiverBatchProcessorThread transactionReceiverThread 
				= new TransactionReceiverBatchProcessorThread(
