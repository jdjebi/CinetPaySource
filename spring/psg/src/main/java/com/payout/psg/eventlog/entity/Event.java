package com.payout.psg.eventlog.entity;
...
public class Event {
	...
	private String originService = "GATEWAY";
	...
	public Event(Event event){
		...
		this.entityRef = event.getEntityRef();
		this.strictType = event.getStrictType();
		this.loggingLevel = event.getLoggingLevel();
		this.date = event.getDate();
		this.eventData = event.getEventData();
		this.EventFormatVersion = event.getEventFormatVersion();
		this.EventFormatVersionNumber = event.getEventFormatVersionNumber();
		this.originService = event.getOriginService();
		this.id = event.getId();
	}
